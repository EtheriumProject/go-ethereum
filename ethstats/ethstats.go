...
// Service implements an Etherium netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Etherium      // Full Etherium service if monitoring a full node
	les    *les.LightEthereum // Light Etherium service if monitoring a light node
...
func New(url string, ethServ *eth.Etherium, lesServ *les.LightEthereum) (*Service, error) {
