...
// ReleaseOracle is an Etherium contract to store the current and previous
// versions of the go-etherium implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Etherium user, either
