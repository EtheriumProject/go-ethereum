...
// setting up a new or managing an existing Etherium private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Etherium private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Etherium network down to  |")
	...
	log.Info("Administering Etherium network", "name", w.network)
