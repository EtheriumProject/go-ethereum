...
type wizard struct {
	...
	services map[string][]string   // Etherium services known to be running on servers
...
// converts it to an Etherium address. If an empty line is entered, the default
// value is returned.
