...
import (
	...
	"github.com/etherium/go-etherium/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Etherium contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Etherium contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Etherium contract Solidity source to build and bind")
