...
// Package ethclient provides a client for the Etherium RPC API.
package ethclient
...
import (
	...
	"github.com/etherium/go-etherium"
...
// Client defines typed wrappers for the Etherium RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, etherium.NotFound
	}
...
func (ec *Client) SyncProgress(ctx context.Context) (*etherium.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (etherium.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q etherium.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q etherium.FilterQuery, ch chan<- types.Log) (etherium.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q etherium.FilterQuery) interface{} {
...
func (ec *Client) CallContract(ctx context.Context, msg etherium.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg etherium.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg etherium.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg etherium.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
