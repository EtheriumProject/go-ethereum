...
// ecrecover extracts the Etherium account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Etherium address
...
// Etherium testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Etherium address of the signing key
...
// Author implements consensus.Engine, returning the Etherium address recovered
