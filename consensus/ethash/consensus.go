...
// rules of the stock Etherium ethash engine.
...
func calcDifficultyMetropolis(time uint64, parent *types.Header) *big.Int {
	// https://github.com/etherium/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/etherium/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/etherium/EIPs/blob/master/EIPS/eip-2.mediawiki
	// algorithm:
	// diff = (parent_diff +
