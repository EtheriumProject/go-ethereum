...
import (
	...
	"github.com/etherium/go-etherium/les/flowcontrol"
	"github.com/etherium/go-etherium/light"
...
func NewLesServer(eth *eth.Etherium, config *eth.Config) (*LesServer, error) {
