...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // Etherium blockchain to handle the consensus
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call etherium.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call etherium.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call etherium.CallMsg) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call etherium.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, error) {
