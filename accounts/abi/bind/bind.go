...
// Package bind generates Etherium contract Go bindings.
//
// Detailed usage document and tutorial available on the go-etherium Wiki page:
// https://github.com/etherium/go-etherium/wiki/Native-DApps:-Go-bindings-to-Etherium-contracts
package bind
