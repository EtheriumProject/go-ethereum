...
// the `coin_type` 60' (or 0x8000003C) to Etherium.
//
// The root path for Etherium is m/44'/60'/0'/0 according to the specification
// from https://github.com/etherium/EIPs/issues/84, albeit it's not set in stone
