...
// Package accounts implements high level Etherium account management.
package accounts
...
// Account represents an Etherium account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Etherium account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain etherium.ChainStateReader)
