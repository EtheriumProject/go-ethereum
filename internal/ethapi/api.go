...
import (
	...
	"github.com/etherium/go-etherium/common/math"
...
// PublicEthereumAPI provides an API to access Etherium related information.
...
// ProtocolVersion returns the current Etherium protocol version this node supports
...
// Sign calculates an Etherium ECDSA signature for:
...
//
// https://github.com/etherium/go-etherium/wiki/Management-APIs#personal_sign
...
//
// https://github.com/etherium/go-etherium/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid Etherium signature (V is not 27 or 28)")
	}
...
// PublicBlockChainAPI provides an API to access the Etherium blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
...
//
// https://github.com/etherium/wiki/wiki/JSON-RPC#eth_sign
...
// Version returns the current etherium protocol version.
