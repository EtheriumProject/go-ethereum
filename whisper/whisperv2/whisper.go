...
import (
	...
	"github.com/etherium/go-etherium/crypto/ecies"
	"github.com/etherium/go-etherium/event/filter"
...
// Whisper represents a dark communication interface through the Etherium
...
// New creates a Whisper client ready to communicate through the Etherium P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
