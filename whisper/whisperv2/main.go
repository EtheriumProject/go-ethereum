...
import (
	...
	"github.com/etherium/go-etherium/logger"
	"github.com/etherium/go-etherium/p2p"
	"github.com/etherium/go-etherium/p2p/nat"
	"github.com/etherium/go-etherium/whisper"
)
...
func main() {
	...
	// Create an Etherium peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Etherium peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Etherium peer: %v.\n", err)
		os.Exit(1)
	}
