...
// Syncing provides information when this nodes starts synchronising with the Etherium network and when it's finished.
...
type SyncingResult struct {
	...
	Status  etherium.SyncProgress `json:"status"`
}
