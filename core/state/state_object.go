...
// stateObject represents an Etherium account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of etherium address of the account
	data     Account
	db       *StateDB
...
// Account is the Etherium consensus representation of accounts.
