...
// Package types contains data types related to Etherium consensus.
package types
...
// Header represents a block header in the Etherium blockchain.
type Header struct {
...
// Block represents an entire block in the Etherium blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Etherium
...
// EncodeRLP serializes b into the Etherium RLP block format.
